              ...
              <div className="space-y-1.5 border-t border-slate-100 dark:border-slate-800/60 pt-4">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="block w-full pl-9 pr-3 py-2 bg-slate-50 dark:bg-slate-850 border border-slate-200 dark:border-slate-700/80 rounded-xl text-xs text-slate-900 dark:text-cyan-300 focus:outline-none"
                  />
                </div>
              </div>
